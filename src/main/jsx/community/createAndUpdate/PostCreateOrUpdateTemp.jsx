...
const PostCreateOrUpdateTemp =({onClose,inputform,etctem,etcbutton,nextStep,onCreateOrUpdate, buttonValue}) => {
    ...
    return(
        <CreateMain onClick={(e)=>e.stopPropagation()}>
            ...
            <PostButton onClick={()=>{onCreateOrUpdate()}}>{buttonValue}</PostButton>
        </CreateMain>
    );
}


export default PostCreateOrUpdateTemp;
